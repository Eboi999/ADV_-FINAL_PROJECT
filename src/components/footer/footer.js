                    ...
                    <div className='container-fluid'>
                        <div className='row'>
                            <div className='col-md-3 part1'>
                                ...
                                <p><LocationOnOutlinedIcon /> <strong>Address</strong>: DAVAO CITY</p>
                                <p><HeadphonesOutlinedIcon /> <strong>Call Us:</strong> 09422213454 </p>
                                ...
                                <div className='m-auto d-flex align-items-center phWrap'>
                                    <div className='phNo d-flex align-items-center mx-5'>
                                        ...
                                        <div className='info ml-3'>
                                            <h3 className='text-g mb-0'>911</h3>
